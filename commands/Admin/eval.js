...
module.exports = class extends Command {
    ...
    async run(msg, [code]) {
        const flagTime =
            "no-timeout" in msg.flags ? ("wait" in msg.flags ? Number(msg.flags.wait) : this.timeout) : Infinity;
        ...
        return this.handleMessage(
            ...
            { success, result, time, footer, language }
        );
    }
            ...
            default: {
                ...
                return msg.sendMessage(
                    msg.language.get(
                        ...
                        time,
                        util.codeBlock(language, result),
                        footer
                    )
                );
            }
